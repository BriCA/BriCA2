...
TEST_CASE("emit/pipe/null component serial scheduling", "[scheduler]") {
...
TEST_CASE("emit/pipe/null component thread parallel scheduling",
          "[scheduler]") {
  std::string key = "default";
  Buffer value({1, 2, 3});
